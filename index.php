...
<head>
    ...
    <link rel="shortcut icon" href="./frontend/assets/rever.png" type="image/x-icon">
...
<body>
    <div class="container-form">
        ...
        <p id="p_login">Bem-vindo de volta! Insira suas credenciais para acessar sua conta.</p>
        <form class="login-form" id="form_login">
            <img src="./frontend/assets/rever-logo.webp" id="img_rever" class="logo-rever-tecnologia" alt="Rever Tecnologia">
